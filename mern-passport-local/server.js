...
const MongoStore = require('connect-mongo')(session); // <---------- Mongo Session Store
...
// *********  DATABASE SECTION  *************
// Options to clear Mongo DB / Mongoose Warnings
mongoose.set('useNewUrlParser', true);
mongoose.set('useCreateIndex', true);
// Connect to Mongo DB
mongoose.connect(process.env.MONGODB_URI || "mongodb://localhost/mern_passport");
...
app.use(session({
  store: new MongoStore({ mongooseConnection: mongoose.connection }), // <---------- Session Store
